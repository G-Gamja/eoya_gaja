...
import '../../model/memoDateModel.dart';

//*하루의 산책량이나 제공한 간식,식사의 양을 기록하는 페이지
// ignore: camel_case_types
class addDailyPage extends StatefulWidget {
  @override
  _addDailyPageState createState() => _addDailyPageState();
}
...
class _addDailyPageState extends State<addDailyPage> {
  ...
  List<String> _snackvariationList = ['메모', '사료', '간식'];
  // 스탭퍼용 변수 수정해서 쓸 것
  String? firstName;
  String? lastName;
  ...
  void adddateSQL(String inputDate) async {
    await DatabaseHelper.instance.add(memoDateModel(enrolledDate: inputDate));
  }
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownSearch<String>(
                      dropDownButton: FaIcon(FontAwesomeIcons.caretDown),
                      clearButton: FaIcon(FontAwesomeIcons.times),
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    //Get.off(()=>MainScreen());
                    adddateSQL(DateFormat('yyyy-MM-dd')
