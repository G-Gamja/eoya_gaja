...
class WarpIndicator extends StatefulWidget {
  ...
  const WarpIndicator(
      ...
      required this.child,
      this.starsCount = 30,
      this.skyColor = Colors.black, //Colors.indigo,
      this.starColorGetter = _defaultStarColorGetter,
      required this.selectedDate})
      : super(key: key);

  static Color _defaultStarColorGetter(int index) =>
      HSLColor.fromAHSL(1, Random().nextDouble() * 360, 0.4, 0.98).toColor();
...
class _WarpIndicatorState extends State<WarpIndicator>
  ...
  Future<void> requestNew() async {
    ...
    //refresh contents
    //await resetStorage();
    //todo 이거 추가하느라 전역변수도 추가해서 수정해라잉
                      ...
                      builder:
                        ...
                        return CustomPaint(
                          painter: Sky(
                              ...
                              //!캘린더 바탕 색은 여기서
                              color: Colors
                                  .black //const Color(0xff1d256e), //Colors.indigo[200] as Color,
                              ),
